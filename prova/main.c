...
uint16_t AcX = 0, AcY = 0, AcZ = 0, Tmp = 0, GyX = 0, GyY = 0, GyZ = 0;

int gx = 0, gy = 0, gz = 0;
#define FREQ 30.0 // sample freq in Hz

int gyrXoffs = -281.00, gyrYoffs = 18.00, gyrZoffs = -83.00;
int gSensitivity = 65.5; // for 500 deg/s, check data sheet
...
int main(void){
	...
	for(i=0; i<5000; i++){
		...
		int jj;
		jj = j;
		printf("int %d float %f float_int %d\n", k, j, j);
		printf("%d\n", jj);*/
